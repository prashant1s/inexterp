...
const FAQS = [
  { question: "What is iNextERP?", answer: "iNextERP is a complete cloud-based Enterprise Resource Planning solution designed for retail, wholesale, and manufacturing businesses." },
  { question: "Is iNextERP GST compliant?", answer: "Yes, our platform is 100% compliant with the latest GST regulations, including e-invoicing and direct return filing." },
  { question: "Can I access iNextERP on mobile?", answer: "Absolutely. We offer dedicated mobile applications for both iOS and Android, plus a fully responsive web interface." },
  { question: "How secure is the software?", answer: "We use bank-level 256-bit encryption, daily automated backups, and multi-factor authentication to keep your data secure." },
  { question: "How long does implementation take?", answer: "Standard implementation takes between 3 to 7 days depending on your data migration needs." },
  { question: "Do you provide training and support?", answer: "Yes, we provide free onboarding training and 24/7 dedicated customer support." },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-primary-600 rounded-3xl p-8 md:p-10 text-white shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl font-bold mb-3">Ready To Simplify Your Business?</h2>
              <p className="text-primary-100 mb-8 max-w-md">
                Book a free demo today and see how iNextERP can help your business grow faster.
              </p>
